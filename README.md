# Fetch-API is my end of year project that i worked on during my internship with APM Terminals, this API is capable of getting JSON file from a certain link and a giving
